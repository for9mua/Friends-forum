...
<template>
  <div>
      ...
      <el-table-column label="用户"><template #default="scope"><span v-if="scope.row.userId">{{ state.userOptions.find(v => v.id === scope.row.userId) ? state.userOptions.find(v => v.id === scope.row.userId).name : '' }}</span></template></el-table-column>
        ...
        <el-table-column label="操作" width="180">
          <template #default="scope">
            <el-button type="primary" @click="handleEdit(scope.row)" v-if="auths.includes('orders.edit')">编辑</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" title="积分订单信息" width="40%">
      <el-form ref="ruleFormRef" :rules="rules" :model="state.form" label-width="80px" style="padding: 0 20px" status-icon>
        <el-form-item prop="code" label="订单编号">
          <el-input v-model="state.form.code" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="goodsId" label="商品">
          <el-select clearable v-model="state.form.goodsId" placeholder="请选择"  style="width: 100%">
